const perguntas = [[
    //Ginástica
    {
        enunciado: "Quais são os principais desafios enfrentados pelo produtores rurais atualmente?",
        alternativas: [
            {
    ...
    {
        enunciado: "Como as mudanças climáticas estão afetando a agricultura e a pecuária?",
        alternativas: [
            {
    ...
    {
        enunciado: "Quais práticas de manejo sustentável podem ser implementadas nas propriedades rurais?",
        alternativas: [
            {
    ...
    {
        enunciado: "Como a tecnologia está ?",
        alternativas: [
            {
